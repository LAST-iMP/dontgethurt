...
import static com.lastimp.dgh.api.enums.BodyCondition.CLAMPED_BLEEDING;
import static com.lastimp.dgh.api.enums.BodyCondition.SURGERY_INCISION;
...
public class Hemostat extends AbstractPartlyHealItem {
    ...
    protected boolean healOn(@NotNull ServerPlayer source, @NotNull ServerPlayer target, BodyComponents component) {
        return PlayerHealthCapability.getAndSet(target, (h) -> {
            ...
            body.setConditionValue(CLAMPED_BLEEDING, CLAMPED_BLEEDING.maxValue);
            return true;
        });
    }
}
