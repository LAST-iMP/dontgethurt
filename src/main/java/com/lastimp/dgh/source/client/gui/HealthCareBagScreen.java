...
public class HealthCareBagScreen extends AbstractContainerScreen<HealthCareBagMenu> {
    private static final ResourceLocation HUD_BACKGROUND = ResourceLocation.fromNamespaceAndPath(DontGetHurt.MODID, "textures/gui/healthcare_bag_hud.png");

    private static final int PANEL_WIDTH = 176;   // 面板宽度
    private static final int PANEL_HEIGHT = 112;  // 面板高度

    public HealthCareBagScreen(HealthCareBagMenu menu, Inventory playerInventory, Component title) {
