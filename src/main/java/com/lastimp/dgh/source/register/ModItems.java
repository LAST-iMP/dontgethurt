...
public class ModItems {
    ...
    public static final DeferredItem<Brain> BRAIN = registerItem(
            "brain", Brain::new,
            new Item.Properties().stacksTo(1)
    );

    public static final DeferredItem<Eye> EYE = registerItem(
            "eye", Eye::new,
            new Item.Properties().stacksTo(1)
    );

    public static final DeferredItem<Heart> HEART = registerItem(
            "heart", Heart::new,
            new Item.Properties().stacksTo(1)
    );

    public static final DeferredItem<Kidney> KIDNEY = registerItem(
            "kidney", Kidney::new,
            new Item.Properties().stacksTo(1)
    );

    public static final DeferredItem<Liver> LIVER = registerItem(
            "liver", Liver::new,
            new Item.Properties().stacksTo(1)
    );

    public static final DeferredItem<Lungs> LUNGS = registerItem(
            "lungs", Lungs::new,
            new Item.Properties().stacksTo(1)
    );

    public static final DeferredItem<Muscle> MUSCLE = registerItem(
            "muscle", Muscle::new,
            new Item.Properties().stacksTo(1)
    );

    public static final DeferredItem<Neuro> NEURO = registerItem(
            "neuro", Neuro::new,
            new Item.Properties().stacksTo(1)
    );

    public static final DeferredItem<Skin> SKIN = registerItem(
            "skin", Skin::new,
            new Item.Properties().stacksTo(1)
    );

    public static final DeferredItem<SpinalCord> SPINAL_CORD = registerItem(
            "spinal_cord", SpinalCord::new,
            new Item.Properties().stacksTo(1)
    );

    public static final DeferredItem<Stomach> STOMACH = registerItem(
            "stomach", Stomach::new,
            new Item.Properties().stacksTo(1)
    );
