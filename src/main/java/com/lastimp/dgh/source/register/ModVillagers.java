...
public class ModVillagers {
    ...
    public static void addCustomTrades(VillagerTradesEvent event) {
        if (event.getType() == DOCTOR_MAKER.getKey()) {
            ...
            // 1级交易：绷带、血包、石膏
            level1Trades.add((level, trader, rand) -> new MerchantOffer(
            ...
            // 2级交易：消毒剂、吗啡、缝合线
            level2Trades.add((level, trader, rand) -> new MerchantOffer(
            ...
            level3Trades.add((level, trader, rand) -> new MerchantOffer(
            ...
            level4Trades.add((level, trader, rand) -> new MerchantOffer(
                    new ItemCost(Items.EMERALD, 5),
                    new ItemStack(ModItems.NEEDLE.get(), 2),
                    10, 15, 0.05F
            ));
            ...
            // 5级交易：停滞袋、甘露醇
            level5Trades.add((level, trader, rand) -> new MerchantOffer(
