...
public class BulletsInjuryHandler {
    public static void handleBullet(DamageSource source, float damageAmount, LivingEntity entity, LivingDamageEvent.Pre event) {
    ...
    public static void handleBulletByPass(DamageSource source, float damageAmount, LivingEntity entity, LivingDamageEvent.Pre event) {
