...
public enum BodyCondition {
    //肢体
    BURN            ("烧伤",  1.0f / Config.base_self_healing_time, 0.2f, 0.0f, 0.0f, 2.0f, BodyCondition.pathRoot+"burn"),
    INTERNAL_INJURY ("内伤",  1.0f / Config.base_self_healing_time, 0.5f, 0.0f, 0.0f, 2.0f, BodyCondition.pathRoot+"internal_injury"),
    OPEN_WOUND      ("开放伤", 1.0f / Config.base_self_healing_time, 0.5f, 0.0f, 0.0f, 2.0f, BodyCondition.pathRoot+"open_wound"),
    ...
    BRAIN_DAMAGE    ("脑损伤", 0.001f, 2.0f, 0.0f, 0.0f, 2.0f, BodyCondition.pathRoot+"brain_damage"),
    //血液
