...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.MORPHINE.get(), 2)
                ...
                .save(recipeOutput, ResourceHelper.ModResource("morphine"));
    ...
    public static void registerBrewingRecipes(RegisterBrewingRecipesEvent event) {
        ...
        builder.addMix(Potions.STRONG_REGENERATION, ModItems.MORPHINE.get(), ModPotions.COMBAT_STIMULANT_POTION);
        builder.addMix(Potions.STRONG_HARMING, ModItems.MORPHINE.get(), ModPotions.ANALGESIA_POISON_POTION);
    }
}
