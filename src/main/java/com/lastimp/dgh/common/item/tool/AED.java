...
import static com.lastimp.dgh.common.capability.bodyPart.base.BodyCondition.BURN;
...
public class AED extends AbstractDirectHealItems {
    ...
    @Override
    public void appendHoverText(ItemStack stack, @Nullable Level p_41422_, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
