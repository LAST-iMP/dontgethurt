...
public class ModVillagers {
    public static final IEntry<PoiType, PoiType> DOCTOR_POI = PlatformService.REGISTRY_HANDLER.registerPoiType("doctor_poi",
            () -> new PoiType(
    ...
    public static final IEntry<VillagerProfession, VillagerProfession> DOCTOR_MAKER = PlatformService.REGISTRY_HANDLER.registerVillagerProfession("doctor",
