...
import com.lastimp.dgh.common.container.IItemHandler;
...
public class HealthMenu extends AbstractContainerMenu {
    ...
    protected IBackpackInventory bagHandler;
    ...
    public void saveBag() {
        if (this.bagHandler != null) {
            ...
            bagTag.put("inv", this.bagHandler.serialize());
        }
    }
    ...
    public void openBag(ItemStack stack) {
        this.saveBag();
        this.bagStack = stack;
        this.bagHandler = PlatformService.BACKPACK_FACTORY.get(stack);
