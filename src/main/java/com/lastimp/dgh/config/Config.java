...
public class Config {
    ...
    public static final ModConfigSpec.IntValue DAMAGE_PART_STRICK_LEVEL = BUILDER
            .comment("伤害部位严格等级：0-随机部位，1-少量部位约束，2-大量部位约束，3-严格部位")
            .defineInRange("DAMAGE_PART_STRICK_LEVEL", 2, 0, 3);

    public static final ModConfigSpec.BooleanValue LIMITED_BODY_PART_VITALITY_LOST = BUILDER
            .comment("受限的部位生命损伤")
